...
# 2.4. Tema (Themes)
ggplot2 menyediakan berbagai tema untuk mengatur tampilan grafik. Tema dapat digunakan untuk mengubah elemen seperti latar belakang, grid, dan font. Beberapa tema populer adalah theme_minimal(), theme_classic(), dan theme_dark().
